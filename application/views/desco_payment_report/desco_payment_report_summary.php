                        ...
                        <div class="adv-table">
                            <table class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $counter = 0; $total_payment_amount=0;  $total_unit = 0; $payment_amount = 0;
                                    $total_unit_tot=0;
                                    foreach ($desco_bill_payment as $row) :
                                        ...
                                        $totalresult = $this->db->where('hid', $hid)->get('desco_bill_payment')->result();
                                        foreach($totalresult as $totals){
...
<script>
	...
	//	$('#'+id+' td:last-child').remove();
		...
		$('body').html(tabledata);	
		window.print();
	    location.href ="<?= base_url()?>desco_payment_report" ;
	}
