                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm"  role="form" method="post"  action="<?php echo site_url('indirect_income/addIndirectIncome'); ?>" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" name="company" id="company" onchange="getIncome(this.value)"  required> <!-- input-sm m-bot15  -->
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" name="income_type" id="income_type"  required> <!-- input-sm m-bot15  -->
