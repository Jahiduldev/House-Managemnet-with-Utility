                            ...
                            <table class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    ...
                                    foreach ($get_salary_deduct_data as $row) :
                                        ...
                                        $deduct_type_id=$row->deduct_type;
                                        $amount = $row->amount;
                                        $note = $row->note;
                                        $date = $row->date;
                                        ...
                                        endforeach;
                                          ...
                                          $query_2 = $this->db->query("select * from salary_deduct_type where id='$deduct_type_id'");
                                          $result_2 = $query_2->result();
                                        foreach ($result_2 as $row_add):
                                            $deduct_type = $row_add->type;
        ...
        <div class="modal fade" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('salary_deduct_report/editMenu'); ?>">
                            ...
                            <div class="form-group">
                                <label for="inputSuccess" class="col-lg-3 col-sm-3 control-label">Deduct Type*</label>
                                <div class="col-lg-9">
