    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="color:black;">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('all_floor/addPayment'); ?>">
                   ...
                   <!--  <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                             <select class="form-control"  onchange="getFloor(this.value)" id="name_house" name="name_house" required>
				...
				<input type="text" class="form-control"  id="floor_code" name="floor_code"  required>
                        </div>
