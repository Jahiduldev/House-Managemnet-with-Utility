            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                      <b style="color:blue;">  Update DESCO Meter </b>
                    </header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Update DESCO Meter</h4>
            </div>

            <div class="modal-body" style="color:black;">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('view_desco/addPayment'); ?>">
		    ...
		    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Billing Name*: </label>
                        <div class="col-lg-9">		
		  ...
		  <div class="form-group">
					 ...
					 <div class="form-group">
                       ...
                       <div class="form-group">
                           <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Load: </label>
                            <div class="col-lg-9">		
		       ...
		       <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Meter Name: </label>
                        <div class="col-lg-9">		
                                   
				<input type="text" class="form-control"  id="meter_nm" name="meter_nm"  >
                        </div>
