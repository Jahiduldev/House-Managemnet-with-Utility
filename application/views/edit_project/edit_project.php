                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addDesignationForm"  role="form" method="post"  action="<?php echo site_url('view_client/editClientData'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" name="company" id="company" onchange="getClient(this.value)" required> <!-- input-sm m-bot15  -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Project Name" id="project" name="project" value="<?=$name?>" required>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" placeholder="Enter Project Description" id="project_description" name="project_description" required><?=$description?></textarea>
                                </div>
                            </div>
