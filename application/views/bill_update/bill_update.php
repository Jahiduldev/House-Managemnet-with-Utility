                ...
                <section class="panel">
                    ...
                    <div class="panel-body" style="background:#E4F8EA;color:black; ">
						...
						<div class="form-group">
							<form method="POST" action="<?php echo base_url(); ?>bill_update/get_house">	
...
onclick="addModalsms('<?=$id."-".$rent."-".$elec."-".$gas."-".$water."-".$service."-".$garage."-".$preunit."-".$curunit."-".$total_unit."-".$dueamount."-".$mont."-".$totalamount."-".$utilitydue?>'); " 
style="" 
											> <?php if($status==0){ echo ' SMS Action '; } ?></button>
