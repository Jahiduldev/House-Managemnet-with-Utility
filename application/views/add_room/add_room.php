                ...
                <section class="panel">
					...
					<header class="panel-heading">
                     ...
                     <div class="panel-body" style="background:#008B8B;color:white; ">
						...
						action="<?php echo site_url('add_room/addPayment'); ?>" >
							...
							<div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="flat" name="flat" required> <!-- input-sm m-bot15  -->
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-3">
								      <input type="text"  class="form-control" placeholder="Enter Room Name"  name="floorname[0]" required>                            
                                </div>   
                                <div class="col-lg-3">
								<input type="text"  class="form-control" placeholder="Enter Room Code"  name="floorcode[0]" required>
	...
	function addheads(id){ 
		if(id=='deb'){ strid = ++debid; }else{ strid = ++credid; }
			strings = '<div id="'+ id + strid +'">'+
				...
				'<div class="col-lg-3">'+
					'<input type="text"  class="form-control" placeholder="Enter Room Name"   name="floorname['+ strid +']" required>'+
				'</div>'+ 
				'<div class="col-lg-3">'+
				'<input type="text"  class="form-control" placeholder="Enter Room Code"    name="floorcode['+ strid +']" required>'+
				'</div>'+
				'<div class="col-lg-4">'+
