                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm"  role="form" method="post"  action="<?php echo site_url('add_employee/addEmployeeData'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="company" name="company" onchange="getDepartment(this.value)"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="department" name="department" onchange="getDesignation(this.value)"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Gross Salary" id="gross_salary" name="gross_salary">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Reporting To" id="reporting_to" name="reporting_to">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="default-date-picker form-control" placeholder="Enter Appointed Date" id="appointed_date"  name="appointed_date">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="default-date-picker form-control" placeholder="Enter Joining Date " id="joining_date"  name="joining_date">
                                </div>
                            </div>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="default-date-picker form-control" placeholder="Enter Prohibition Period" id="prohibition_period"  name="prohibition_period">
                                </div>
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" placeholder="Enter Present Address" id="present_address" name="present_address"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" placeholder="Enter Permanent Address" id="permanent_address" name="permanent_address"></textarea>
                                </div>
                            </div>
