    ...
    <section class="wrapper site-min-height">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body" style="background:#E4F8EA;color:black; ">
						...
						<div class="form-group">
							<form role="form" class="cmxform form-horizontal tasi-form" method="post"  id="RoleForm" action="<?php echo site_url('payment_wasa_bill/searchData') ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                      <b style="color:blue;">  Payment WASA Bill </b>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><?php echo  $total_unit; ?></td>
                                             ...
                                             <td><?php echo $last_update; ?></td>
                                              <td><?php echo $note; ?></td>
<td><button class="btn btn-primary btn-xs" onclick="addModal('<?=$id."asad".$house_name."asad".$acct_number."asad".$meter_number."asad".$hid?>'); ">Payment WASA Bill </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="color:black;">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('payment_wasa_bill/addPayment'); ?>" enctype="multipart/form-data">
...
<script>
    ...
    function deletepayment(id){
       ...
       if(confirm('Confirn Delete Payment')){	
			$.ajax({
				type: "Post",
				url: "<?php echo site_url('payment_wasa_bill/cancelpayment'); ?>",
				data: {'id':id } ,
