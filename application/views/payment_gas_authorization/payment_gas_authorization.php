    ...
    <section class="wrapper site-min-height">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body" style="background:#E4F8EA;color:black; ">
						...
						<div class="form-group">
							<form role="form" class="cmxform form-horizontal tasi-form" method="post"  id="RoleForm" action="<?php echo site_url('payment_gas_authorization/searchData') ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                      <b style="color:blue;">  Payment GAS Authorization </b>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Payment GAS Bill Authorization</h4>
            </div>

            <div class="modal-body" style="color:black;">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('payment_gas_authorization/addPayment'); ?>" enctype="multipart/form-data">
...
<script>
    ...
    function deletepayment(id){
       ...
       if(confirm('Confirn Delete Payment')){	
			$.ajax({
				type: "Post",
				url: "<?php echo site_url('payment_gas_authorization/cancelpayment'); ?>",
				data: {'id':id } ,
