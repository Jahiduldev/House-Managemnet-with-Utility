...
class Salary_add_report extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Salary Add Report';
            ...
            $this->load->view('salary_add_report/salary_add_report',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('salary_add_report/js_salary_add_report',$data);
