...
class Payment_desco_bill extends CI_Controller {
...
$trx = mysql_real_escape_string($this->input->post('trx'));
		    ...
		    $res_clients= $this->db->query("update desco_bill set  status=1,sms_send=3 where id=$id ");
			...
			if($fileName !=''){  $data['image_name'] = $fileName; }else{$data['image_name']=''; }
