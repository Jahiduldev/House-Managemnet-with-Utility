...
class View_employee extends CI_Controller {
    ...
    public function getTableData() {
        ...
        $columns = array(
            ...
            array('db' => 'company', 'dt' => 2,'formatter' => function ($rowvalue, $row) {
            ...
            array('db' => 'department', 'dt' => 3,'formatter' => function ($rowvalue, $row) {
            ...
            array('db' => 'designation', 'dt' => 4,'formatter' => function ($rowvalue, $row) {
            $res_company= $this->common_model->getDataWhere("designation","id",$rowvalue);
            foreach($res_company as $row):
               $designation_name= $row->designation;
            endforeach;
                    return $designation_name;
                }),
            array('db' => 'mobile_number', 'dt' => 5),
