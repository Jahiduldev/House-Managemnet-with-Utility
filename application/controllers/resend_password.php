...
class Resend_password extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('resend_password/header',$data);
    ...
    public function get_user_id() {
       ...
       // $from="here.cms@gmail.com";
        $to = $email_add;
        $subject = "Cubes Pizza Attendance Change Password Mail";
        $message="<html>
            <body>
            please Click this link to change your password.
            http://221.120.98.162/shop_att/user_new_password/get_new_password/".rtrim(base64_encode($idval),'=')."/". $rand_num."
            </body>
            </html>";
