...
class User_new_password extends CI_Controller {
    ...
    public function get_new_password() {
        ...
        $this->load->view('user_new_password/header',$data);
        $this->load->view('user_new_password/index',$data);
        $this->load->view('common/footer',$data);
    ...
    public function set_new_password() {
        ...
        if($result):
            ...
            $to = $this->mmslEmail;
            $subject = "Cubes Pizza Attendance New Password Mail";
            $message="<html>
            <body>
             Your Cubes Pizza Attendance new password is : <br>".$new_password."
            </body>
            </html>";
